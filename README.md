...
![a screen recording of the "game"](https://raw.githubusercontent.com/awwsmm/portfolio/master/demo.gif)
...
```shell
git clone https://github.com/awwsmm/portfolio.git && cd portfolio
```
